...
export default function DoctorLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // TODO: Replace with actual API call to /api/auth/login with role: "doctor"
      ...
      <div className="hidden lg:flex lg:w-[30%] bg-blue-600 flex-col justify-between p-8">
        ...
        <div className="flex-1 flex flex-col justify-center items-center text-center">
          <h1 className="text-3xl font-bold text-white mb-4 leading-tight">
            Welcome back, Doctor! Access your portal.
          </h1>
          <p className="text-blue-100 text-lg leading-relaxed">
            Manage patients, consultations, and medical records efficiently.
          </p>
        </div>
